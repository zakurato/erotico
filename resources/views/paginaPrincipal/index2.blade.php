    ...
    <div class="container container--flush">
        <div class="featured-product">
            ...
            <div class="card card--collapsed ">
                <div id="product-zoom-template--14562732638271__featured-product" class="product__zoom-wrapper">
                </div>
                    ...
                    <div class="product-meta">
                        ...
                        <div class="product-form__info-list">
                            ...
                            <div class="product-form__info-item">
                                ...
                                <div class="product-form__info-content" role="region" aria-live="polite">
                                    <div class="price-list" id="colorTemporada{{ $productoTemporada->color }}">
                                        <span class="price">
                            ...
                            <div class="product-form__info-item">
                                ...
                                <div class="product-form__info-content" role="region" aria-live="polite">
                                    <div id="tamañoTemporada{{ $productoTemporada->tamaño }}" class="price-list">
                                        <span class="price">
                            ...
                            <div class="product-form__info-item product-form__info-item--quantity">
                                <label for="template--14562732638271__featured-product-7064984518719-quantity"
                                    ...
                                    <p>{{ $productoTemporada->descripcion }}</p>
                                </label>
                            </div>
                        </div>
...
<div id="shopify-section-template--14562732638271__05ad0977-fcfc-476f-948d-e9119e0da40c" class="shopify-section">
    ...
    <div id="shopify-section-sections--14562733293631__footer"
        ...
        <a href="https://wa.me/50660168568?text=¿Me%20gustaría%20consultar%20sobre%20un%20producto%3F"
            ...
            <div class="wa__btn_popup" style="left: unset; right: 25px; bottom:200px;">
                <p>
