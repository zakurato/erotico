...
<head>
    ...
    <title>Editar categoría sin color ni tamaño</title>
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="{{ route('formCategoriaSinColorNiTamaño') }}">Inicio</a>
            </div>
        </div><!-- /.container-fluid -->
    </nav>
    <div class="container">
        <h2>Editar categoría sin color ni tamaño</h2>
        <br><br>

        <form action="{{ 'storeActualizarCategoriaSinColorNiTamaño' }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nombreCategoria" autocomplete="off"
                    ...
                    value="{{ $categoriaEditar->nombreCategoriaSinColorNiTamaño }}">
            </div>
