...
<body>
    ...
    <h1>Añadir tamaño o imagenes con el color {{ $color }} seleccionado</h1>
    <br><br><br>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <th style="width: 150px; height: 150px;"><img style="width: 100px; height: 100px;" src="imagesProductos/{{$producto->imagen}}" alt=""></td>
            ...
            @foreach ($fotos as $item)
                ...
                <tr>
                    ...
                    <th style="width: 150px; height: 150px;"><img style="width: 100px; height: 100px;" src="imagesProductos/{{$item->imagen}}" alt=""></td>
                        <th style="width: 150px; height: 150px;">{{$item->color}}</td>
